...
public class ClaimSaverTest
{

    [Fact]
    public void ClaimSaver_save837P_Shouldinsert_WhenNoDuplicates()
    {
        var context = CreateInMemoryContext();

        var tx = BuildClaim("01");

        var result = ClaimSaver.Save837P(new List<TS837P> { tx }, context);

        Assert.True(result);

    }

    private HIPAA_5010_837P_Context CreateInMemoryContext()
    {
    ...
    private static TS837P BuildClaim(string controlNumber)
    {
