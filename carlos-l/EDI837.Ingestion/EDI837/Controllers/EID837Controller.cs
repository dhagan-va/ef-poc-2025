...
namespace EDI837.Controllers
{
    ...
    public class EID837Controller : ControllerBase
    {
        ...
        public IActionResult GetEdi837PTransactionsByFileName(string fileName = "837File.edi", int snipLevel = 1)
        {
        ...
        public async Task<IActionResult> SaveEdi837POriginalTransactionsAsJsonByFileName(string fileName = "837File.edi", int snipLevel = 1)
        {
            List<string> parsingErrors = new List<string>();
            Stream stream = this._ediParserService.GetStreamByFileName(fileName);
        ...
        [HttpGet("SaveEdi837PByFileName/{fileName}/{snipLevel}")]
        public async Task<IActionResult> SaveEdi837PByFileName(string fileName = "837FileFailsSnipLevel2.edi", int snipLevel = 2)
        {
            List<string> parsingErrors = new List<string>();
            Stream stream = this._ediParserService.GetStreamByFileName(fileName);
            if (stream != null)
        ...
        public async Task<IActionResult> S3SaveEdiFileByBucketAndFileName(string bucketName = "edi-bucket",string fileName = "837File.edi", int snipLevel = 1)
        {
            List<string> parsingErrors = new List<string>();
        ...
        public async Task<IActionResult> S3ProcessFilesByBucketAndPrefix(string bucketName = "edi-bucket", string prefix = "837", int snipLevel = 1)
        {
            List<string> parsingErrors = new List<string>();
