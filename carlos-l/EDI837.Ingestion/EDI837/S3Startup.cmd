...
SET AWS_ACCESS_KEY_ID=testing&& SET AWS_SECRET_ACCESS_KEY=testing&& SET AWS_REGION=us-east-1&& aws --endpoint-url=http://localhost:5001 s3 cp samples\275File.edi s3://edi-bucket/837FileFailSnipLevel2.edi
