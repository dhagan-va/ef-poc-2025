...
{
    /// <inheritdoc />
    public partial class TS837P : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TS837Ps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TS837Ps_All_NM1_837P_6_AllNM1Id",
                        column: x => x.AllNM1Id,
                        principalTable: "All_NM1_837P_6",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TS837Ps_BHT_BeginningOfHierarchicalTransaction_8_BHT_BeginningOfHierarchicalTransactionId",
                        column: x => x.BHT_BeginningOfHierarchicalTransactionId,
                        principalTable: "BHT_BeginningOfHierarchicalTransaction_8",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TS837Ps_SE_SEId",
                        column: x => x.SEId,
                        principalTable: "SE",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TS837Ps_ST_STId",
                        column: x => x.STId,
                        principalTable: "ST",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Loop_2000A_837P_TS837Ps_TS837PId",
                        column: x => x.TS837PId,
                        principalTable: "TS837Ps",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TS837Ps_AllNM1Id",
                table: "TS837Ps",
                column: "AllNM1Id");

            migrationBuilder.CreateIndex(
                name: "IX_TS837Ps_BHT_BeginningOfHierarchicalTransactionId",
                table: "TS837Ps",
                column: "BHT_BeginningOfHierarchicalTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_TS837Ps_SEId",
                table: "TS837Ps",
                column: "SEId");

            migrationBuilder.CreateIndex(
                name: "IX_TS837Ps_STId",
                table: "TS837Ps",
                column: "STId");
        }
