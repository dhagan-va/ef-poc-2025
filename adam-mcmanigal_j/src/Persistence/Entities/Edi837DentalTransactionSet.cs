...
/// <see cref="Edi837TransactionSet{TMessage}"/> closed over <see cref="TS837D"/>, mapped to its own table.
/// </summary>
public sealed class Edi837DentalTransactionSet : Edi837TransactionSet<TS837D>
{
    ...
    {
        var entity = new Edi837DentalTransactionSet();
