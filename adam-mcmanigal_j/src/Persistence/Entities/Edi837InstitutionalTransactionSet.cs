...
/// <see cref="Edi837TransactionSet{TMessage}"/> closed over <see cref="TS837I"/>, mapped to its own table.
/// </summary>
public sealed class Edi837InstitutionalTransactionSet : Edi837TransactionSet<TS837I>
{
    ...
    {
        var entity = new Edi837InstitutionalTransactionSet();
