    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TS837s", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TS837s_All_NM1_837P_6_AllNM1Id",
                        column: x => x.AllNM1Id,
                        principalTable: "All_NM1_837P_6",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TS837s_BHT_BeginningOfHierarchicalTransaction_8_BHT_BeginningOfHierarchicalTransactionId",
                        column: x => x.BHT_BeginningOfHierarchicalTransactionId,
                        principalTable: "BHT_BeginningOfHierarchicalTransaction_8",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TS837s_SE_SEId",
                        column: x => x.SEId,
                        principalTable: "SE",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TS837s_ST_STId",
                        column: x => x.STId,
                        principalTable: "ST",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Loop_2000A_837P_TS837s_TS837PId",
                        column: x => x.TS837PId,
                        principalTable: "TS837s",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TS837s_AllNM1Id",
                table: "TS837s",
                column: "AllNM1Id");

            migrationBuilder.CreateIndex(
                name: "IX_TS837s_BHT_BeginningOfHierarchicalTransactionId",
                table: "TS837s",
